...
public class Usage {
    ...
    public static void printUsage(String algorithm){
        ...
        String ankusVersionJarName = "ankus-core2-TFIDF-1.1.0.jar";
        String delimiterSeparateValues = "< {tab} >";
        ...
        if(algorithm.equals(Constants.DRIVE_TF_IDF)){
        	 description = "TF IDF driver based on map/reduce program that computes the data of the Document set in the input files.";
