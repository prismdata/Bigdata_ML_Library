...
public class Usage {
    ...
    public static void printUsage(String algorithm){
        ...
        String ankusVersionJarName = "ankus-core2-etl-1.1.0.jar";
        ...
        if(algorithm.equals(Constants.DRIVER_ETL_FILTER)){
            description = "ETL based on map/reduce program that converts/extract the data set in the input files.";
