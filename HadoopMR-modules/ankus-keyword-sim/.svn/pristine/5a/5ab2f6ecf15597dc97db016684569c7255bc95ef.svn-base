...
public class Usage {
    ...
    public static void printUsage(String algorithm){
        ...
        String ankusVersionJarName = "ankus-core2-keyword-sim-1.1.0.jar";
        ...
        if(algorithm.equals(Constants.DRIVE_KEYWORDSIMILARITY)){
            description = "KeyWordSimilarity driver based on map/reduce program that computes the data of the boolean set in the input files.";
