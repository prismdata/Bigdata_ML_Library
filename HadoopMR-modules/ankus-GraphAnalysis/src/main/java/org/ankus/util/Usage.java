...
public class Usage {
    ...
    public static void printUsage(String algorithm){
        ...
        String ankusVersionJarName = "ankus-core2-GraphAnalysis-1.1.0.jar";
        ...
        if(algorithm.equals(Constants.DRIVE_GRAPHANALYSIS)){
        	description = "GraphAnalysis driver based on map/reduce program that computes the data of the boolean set in the input files.";
