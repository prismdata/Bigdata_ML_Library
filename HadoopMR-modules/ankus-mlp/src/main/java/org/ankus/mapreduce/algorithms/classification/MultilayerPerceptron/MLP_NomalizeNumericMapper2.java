...
public class MLP_NomalizeNumericMapper2 extends Mapper<Object, Text, IntWritable, Text>{
...
//        delimiter = context.getConfiguration().get(ArgumentsConstants.DELIMITER, ",");
        ...
        minArray = CommonMethods.convertIndexStr2DoubleArr(context.getConfiguration().get(ArgumentsConstants.NUMERIC_INDEX));
        maxArray = CommonMethods.convertIndexStr2DoubleArr(context.getConfiguration().get(ArgumentsConstants.NUMERIC_INDEX));        
    }
