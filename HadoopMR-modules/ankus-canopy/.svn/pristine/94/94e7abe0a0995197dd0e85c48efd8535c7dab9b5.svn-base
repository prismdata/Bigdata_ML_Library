...
public class Usage {
    ...
    public static void printUsage(String algorithm){
        ...
        String ankusVersionJarName = "ankus-core2-canopy-1.1.0.jar";
        ...
        if(algorithm.equals(Constants.DRIVER_CANOPY_CLUSTERING)){
            ...
            parameters.append("           [" + ArgumentsConstants.CANOPY_T1 + " <0~1>]\n");
            parameters.append("           [" + ArgumentsConstants.CANOPY_T2 + " <0~1>]\n");
            parameters.append("           [" + ArgumentsConstants.DISTANCE_OPTION + " <{uclidean|manhattan>]\n");
            parameters.append("           [" + ArgumentsConstants.FINAL_RESULT_GENERATION + " <{true|false}>]\n");
