...
//import org.ankus.mapreduce.algorithms.clustering.kmeans.KMeansClusterInfoMgr;
 ...
 * @author Moonie
 */
public class CanopyGlobalCenterReducer extends Reducer<IntWritable, Text, NullWritable, Text>{
            ...
            throws IOException, InterruptedException
    {
        ...
        while(!dataList.isEmpty())
        {
            ...
            context.write(NullWritable.get(), new Text(d));
            dataList.remove(0);
