...
//        String finalOutputFile = "/result.csv";
//        if(!finalComputationAndGeneration_csv(conf, resultPath_1, outputTmp2_2, finalOutputFile))
//        {
//            logger.error("Final Result Integration is Failed...");
//            return 1;
//        }
	...
	private boolean finalComputationAndGeneration_csv(Configuration conf, String inputPath1, String inputPath2, String outputFile) throws Exception
    {
        ...
        for (int i=0;i<status.length;i++)
        {
            ...
            if(fp.getName().indexOf("part-")==0)
            {
                ...
                while((readStr=br.readLine())!=null)
                {
                    ...
                    String qStr = quartileMap.get(tokens[0] + "-1Q") + "," +
                                    quartileMap.get(tokens[0] + "-2Q") + "," +
                                    quartileMap.get(tokens[0] + "-3Q");
                    
                    readStr = readStr.replace("\t", ",");
                    bw.write(readStr + "," + qStr + "\r\n");
                }
